...
def returnDuplicates(listOfElems):
    ...
    dup=[]
    for c in x:
        if(listOfElems.count(c)>4):
            dup.append((c))
    return dup

def multipleBirths(file_path):
    ...
    errorLine = "US14: The following years have more than 5 siblings born at the same time: " + str(dupStatus)
    print(errorLine)
    return errorLine
            
if __name__ == '__main__':
    file = "C:/Users/twang/Desktop/ged/US14_2FamOver.ged"
    multipleBirths(file)